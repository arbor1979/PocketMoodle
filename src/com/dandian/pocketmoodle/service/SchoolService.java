...
import com.dandian.pocketmoodle.util.DownloadUtil.IOnDownloadListener;
...
public class SchoolService extends Service {
	...
	public void downLoadUpdate(String mUrl,int mNotifyId){
		...
		Notification mNotification = new NotificationBean(this,R.drawable.ic_launcher, "开始下载",fileName, System.currentTimeMillis(),downloadPath);
